	...
	// Promo Content & Links
		...
		$wp_customize->add_control( new gltheme_Text_Control(
			...
			array(
				...
				<p><a style="font-size: 14px;color: #ffffff;font-weight: 600;background-color: #51d2cb;border: 3px solid #51d2cb;border-radius: 5px;padding: 5px;text-decoration: none" href="http://doc.ltheme.com/lt-fashion-wordpress-theme-document/" target="_blank" title="Read full theme document">Documentation</a>
